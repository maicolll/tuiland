# Roster 32 agent — stato Fase 1

Stati: `todo` → `draft` → `review` → `approved`

| # | Nome | File | Stato | Hook (breve) |
|---|------|------|-------|--------------|
...
| 10 | Frank | `agents/frank.md` | todo | |
| 11 | Ivan | `agents/ivan.md` | todo | |
| 12 | Jane | `agents/jane.md` | todo | |
| 13 | Kelly | `agents/kelly.md` | todo | |
| 14 | Laura | `agents/laura.md` | todo | |
| 15 | Lily | `agents/lily.md` | todo | |
| 16 | Lisa | `agents/lisa.md` | todo | |
| 17 | Maria | `agents/maria.md` | todo | |
| 18 | Max | `agents/max.md` | todo | |
| 19 | Maya | `agents/maya.md` | todo | |
...
| 27 | Rob | `agents/rob.md` | todo | |
| 28 | Roger | `agents/roger.md` | todo | |
| 29 | Romeo | `agents/romeo.md` | todo | |
| 30 | Sara | `agents/sara.md` | todo | |
